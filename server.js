...
async function getLiveStockForProducts(products) {
    ...
    // Preparamos los IDs para Shopify (necesita el formato gid://shopify/Product/...)
...
app.post("/api/ai/search", async (req, res) => {
  ...
  try {
    ...
    let finalCandidatesList = Array.from(combinedCandidates.values());
     ...
     // 🔥🔥🔥 AQUÍ ESTÁ LA MAGIA: ACTUALIZAMOS STOCK ANTES DE HABLAR 🔥🔥🔥
